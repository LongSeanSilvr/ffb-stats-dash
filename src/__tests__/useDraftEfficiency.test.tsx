...
vi.mock('../api/sleeper', () => ({
  getDrafts: async () => [{ draft_id: "draft_123" }],
  getDraftPicks: async () => [{ pick_no: 1, round: 1, roster_id: 1, player_id: "123" }],
...
describe('Draft Efficiency', () => {
  it('calculates draft efficiency without crashing', async () => {
