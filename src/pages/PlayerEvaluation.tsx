        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <div className="relative">
            <select
              ...
              className="appearance-none bg-white/[0.04] border border-white/10 hover:border-white/20 text-white text-xs font-semibold rounded-xl px-3.5 py-2.5 pr-8 focus:outline-none focus:border-cyan-500/50 cursor-pointer shadow-sm"
            >
              {seasons.map((s) => (
                <option key={s.league.league_id} value={s.league.league_id} className="bg-[#0f1115] text-white">
                  {s.league.season} Season ({s.league.name})
                </option>
              ))}
            </select>
